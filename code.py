...
def scene5():
    ...
    print("{What?}\n")
    narr()
    print("[You know remind me of one of your fiction detectives.]\n")
    long()
...
def scene4():
    ...
    long()
    print("Case: The client has reported that according to him someone has been entering his house and moving objects on purpose.")
    suspense()
    suspense()
